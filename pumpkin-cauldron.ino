...
unsigned long idleInterval = 15000;

void loop()
{
    unsigned long currentMillis = millis();
    if (currentMillis - previousIdleMillis > idleInterval && activePattern == LIGHT_PATTERN_BUBBLE)
    {
    ...
    else if (content == SPOON)
    {
        ...
        setActiveLightPattern(LIGHT_PATTERN_EVIL_LAUGH);
    }
    // | Verified Good
...
unsigned long previousBubbleMillis = 0;
unsigned long lightChangeIntervalBUBBLE = 100;
...
void lightsBubble()
{
    ...
    if (currentMillis - previousBubbleMillis > lightChangeIntervalBUBBLE)
    {
        ...
        previousBubbleMillis = currentMillis;
    }
}

unsigned long previousWitchesMillis = 0;
unsigned long lightChangeIntervalWITCHES = 0;
...
void lightsWitchesCackle()
{
    ...
    if (currentMillis - previousWitchesMillis > lightChangeIntervalWITCHES)
    {
        for (uint8_t i = 0; i < TOTAL_LEDS; i++)
        {
        ...
        previousWitchesMillis = currentMillis;
    }
}
